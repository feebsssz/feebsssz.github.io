...
I work on complex engineering and data-driven systems where *uncertainty*, *nonlinear behavior*, and *operational constraints* shape outcomes. Currently, as a senior data scientist and physicist, I work at a leading Norwegian E&P company, bringing AI and machine learning to accelerate the digital transformation of an industry rooted in physics, risk, and operational judgment.

My background spans *fluid dynamics & multiphase flow*, *combustion*, *aerodynamics* and *energy systems*, combining *physics-based modeling*, *experimental analysis*, *high-performance computing*, and *production machine learning* across academia and industry. This has shaped how I reason about systems governed by incomplete information, instabilities, and coupled dynamics, and how I stay explicit about what can and cannot be inferred from the available data.
...
**Current role**  
Senior Data Scientist, [Aker BP](https://akerbp.com/en/)
...
- [GitHub](https://github.com/feebsssz)

**Personal links**
- [Instagram](https://www.instagram.com/feebsssz/)
